...
class QLearningAgent:
    """
    Implementation of the Q-Learning algorithm (Off-Policy).
    """
    ...
    def __init__(
        ...
        """
        self.env = env
        self.nb_actions = env.action_space.n if nb_actions is None else nb_actions
    ...
    def train(
        ...
        """
        Q-Learning algorithm for off-policy reinforcement learning.
        ...
        for episode in range(nb_episodes):
            ...
            while not (task_completed or episode_over):
                ...
                if task_completed or episode_over:
                    q_next = 0
                else: 
                    q_next = max(
                        [
    ...
    def grid_search(
        ...
        """
        Perform a grid search over hyperparameters for the Q-Learning agent.
